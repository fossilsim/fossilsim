...
Information about the `taxonomy` object and models for simualting taxonomy can be found in the vignette "Simulating taxonomy".
Information about the `fossils` object and models for simualting fossils can be found in the vignette "Simulating fossils".
