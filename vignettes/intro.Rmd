...
Simulating data using `FossilSim` can be as simple as in the following code snippets.
...
`FossilSim` can be used to simulate species taxonomy and fossil sampling times, which are stored and output as the `taxonomy` and `fossils` objects described below. 
...
For detailed information about the `taxonomy` object and models for simualting taxonomy see the vignette "Simulating taxonomy".
For detailed information about the `fossils` object and models for simualting fossils see the vignette "Simulating fossils".
